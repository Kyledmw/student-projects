package com.hms.sensors.temperature.view.util;
 ...
 */
public class TemperatureListAdapter extends ArrayAdapter<ITemperatureReadable> {

    private Calendar _calendar;
    private SimpleDateFormat _dateFormat;

    public TemperatureListAdapter(Context context, List<ITemperatureReadable> temperatureData) {
        super(context, 0, temperatureData);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ITemperatureReadable temperatureReading = getItem(position);
        ...
        ImageView temperatureIconIv = (ImageView)convertView.findViewById(R.id.data_type_icon_iv);
        TextView temperatureValueTv = (TextView)convertView.findViewById(R.id.data_value_tv);
        ...
        String strDate = getDateString(temperatureReading.getTimestampSeconds());
        String strTemperature = Double.toString(temperatureReading.getValue());
        String strTimestamp = getTimeString(temperatureReading.getTimestampSeconds());
        String strMeasurementType = temperatureReading.getType();

        dateHeader.setText(strDate);
        temperatureIconIv.setImageResource(R.drawable.menu_item_temperature);
        temperatureValueTv.setText(strTemperature);
