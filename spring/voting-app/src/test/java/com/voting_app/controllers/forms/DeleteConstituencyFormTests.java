...
@Configuration
@SpringBootTest
public class DeleteConstituencyFormTests {
	...
	public void invalidId() {
		...
		DeleteConstituencyForm cForm = new DeleteConstituencyForm();
		cForm.setId(invalidId);
		
		Set<ConstraintViolation<DeleteConstituencyForm>> constraintViolations = _validator.validate(cForm);
