...
from shared.data_processing_util import negate_word_list, remove_punctuation_word_list, prepare_string_for_negation, n_gram, lemm_word_list, thread_locks
...
class CalcWordFreqInDirThread(Thread):
    ...
    def run(self):
        ...
        while thread_locks:
            "pass"
        self.extracted_words = lemm_word_list(self.extracted_words)
...
class ClassifyTestFilesThread(Thread):
    ...
    def run(self):
        ...
        for file_name in file_list:
            ...
            while thread_locks:
                "pass"
            word_list = lemm_word_list(word_list)
