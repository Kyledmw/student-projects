...
from shared.data_processing_util import negate_word_list, remove_punctuation_word_list, prepare_string_for_negation, n_gram, stem_word_list
...
class CalcWordFreqInDirThread(Thread):
    ...
    def run(self):
        ...
        self.extracted_words = stem_word_list(self.extracted_words)
...
class ClassifyTestFilesThread(Thread):
    ...
    def run(self):
        ...
        for file_name in file_list:
            ...
            word_list = stem_word_list(word_list)
