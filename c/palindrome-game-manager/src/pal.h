...
/*
* Get the length of an integer (amount of digits)
*
...
/*
 * Get the solving character array for a palindrome
 */
char* get_solving_array(int* a, int size_num, int* p, int pal_num, int* total_movs);